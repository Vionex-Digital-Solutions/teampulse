...
api_v1_router.include_router(pulse.router, prefix="/pulses", tags=["pulse"])
api_v1_router.include_router(standup.router, prefix="/standups", tags=["standup"])
api_v1_router.include_router(kudos.router, prefix="/kudos", tags=["kudos"])
api_v1_router.include_router(users.router, prefix="/users", tags=["users"])
api_v1_router.include_router(digest.router, prefix="/digests", tags=["digest"])
